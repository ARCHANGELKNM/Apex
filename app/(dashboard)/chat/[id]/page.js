  ...
  return (
    <>
      ...
      <div className="flex min-h-[calc(100dvh-4rem)] flex-col bg-[#F9F6EE]">
        <div className="border-b-4 border-black px-3 py-2.5 bg-purple-300 flex items-center justify-between shrink-0 sm:px-4 sm:py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-black uppercase text-sm tracking-tight text-black sm:text-base">
                PROTOCOL: {subject}
              </h3>
          ...
          <Badge
            variant="black"
            className={`text-white text-[9px] font-mono font-bold sm:text-[10px] ${isLoading ? "bg-red-500 animate-pulse" : "bg-black"}`}
          >
        ...
        >
          <div className="flex items-center justify-between gap-2">
            <span className="text-[10px] font-black uppercase tracking-tight text-slate-700 sm:text-[11px]">
              Apex assistant
            </span>
            {error && (
              <span className="text-[10px] text-red-600 sm:text-[11px]">
                {error}
              </span>
            )}
          </div>
