    ...
    <>
      <div className="md:hidden w-screen h-18 bg-[#f8f2e8] border-b-[3px] border-black py-3 flex flex-row items-center justify-between z-50 box-border shadow-[0_6px_0_#00000012]">
        ...
        <Button
          ...
          className="border-2 border-black h-11 w-11 p-0 flex items-center justify-center bg-white text-[#171411] shadow-[3px_3px_0_#000] hover:bg-[#f8f3eb] active:translate-x-px active:translate-y-px active:shadow-none transition-all"
        >
          {mobileOpen ? (
      ...
      >
        <div className="space-y-4 overflow-x-hidden w-full h-screen">
          ...
          >
            ...
            <div className="bg-[linear-gradient(135deg,#f3e5c6_0%,#e5d4a7_100%)] px-3 py-1.5 text-center w-full rounded-lg border-2 border-black shadow-[3px_3px_0_#000] md:hidden group-hover/sidebar:md:block max-md:block animate-in fade-in duration-100">
          ...
          <div className="bg-[#f4efe6] border-2 border-black p-2 text-center transition-all w-full flex flex-col items-center justify-center rounded-xl shadow-[3px_3px_0_#00000020]">
            <div className="flex items-center justify-center gap-2 bg-[linear-gradient(135deg,#f3e5c6_0%,#e5d4a7_100%)] text-[#171411] h-9 w-9 md:group-hover/sidebar:w-full md:group-hover/sidebar:h-auto py-1 px-1.5 font-mono text-xs font-black uppercase rounded-md border-2 border-black shadow-[3px_3px_0_#000] max-md:w-full max-md:h-auto shrink-0">
          ...
          <nav className="flex flex-col gap-3 w-full">
            ...
            >
              <Button
                ...
                className={`w-full font-black text-sm uppercase h-12 p-0 rounded-lg md:group-hover/sidebar:px-3 max-md:px-3 border-2 ${
                  isActive("/chat")
                    ? "bg-[linear-gradient(135deg,#f3e5c6_0%,#e5d4a7_100%)] text-[#171411] border-black shadow-[3px_3px_0_#000]"
                    : "bg-white text-[#171411] border-black shadow-[3px_3px_0_#00000018] hover:bg-[#f7f2ea]"
